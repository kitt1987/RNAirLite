#include "com_kh_rnairlite_RNAirLiteModule.h"
...
JNIEXPORT jobject JNICALL Java_com_kh_rnairlite_RNAirLiteModule_checkNewPatch(JNIEnv* env, jobject patch) {
...
JNIEXPORT jobject JNICALL Java_com_kh_rnairlite_RNAirLiteModule_applyPath(JNIEnv* env, jobject raw, jobject patch) {
